public class Navstatic // Statisk klass med variabler som är åtkomliga överallt (nästan). För Navmenyn.
{
    ...
    public static string Navlink1 { get; set; } = string.Empty;

    public static string Navbtn2 { get; set; } = string.Empty;

    public static string Navlink2 { get; set; } = string.Empty;

    public static string Navbtn3 { get; set; } = string.Empty;

    public static string Navlink3 { get; set; } = string.Empty;

    public static string Navbtn4 { get; set; } = string.Empty;
